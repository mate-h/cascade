import { showError, checkWebGPUSupport, getCanvasElement, setCanvasSize } from './utils/dom';
...
const setupResizeHandler = (renderLoopController: RenderLoopController): void => {
