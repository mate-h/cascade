...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'entity-selected': 'bg-entity-primary/10 border-entity-primary shadow-entity-primary/30 shadow-lg ring-1 ring-entity-primary/40',
    'entity-highlighted': 'bg-entity-warning/10 border-entity-warning shadow-entity-warning/30 shadow-lg transform scale-[1.01]',
